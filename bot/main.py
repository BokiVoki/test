...
def main():
    ...
    app.add_handler(CommandHandler("record", handlers.record_handler))
    ...
    app.add_handler(CommandHandler("sync_archive_to_haru", handlers.sync_archive_to_haru_handler))
